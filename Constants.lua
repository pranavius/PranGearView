...
AddOn.EnchantTextReplacements = {
    ...
    -- Midnight Enchants
    { original = L["Empowered"], replacement = L["Emp"] },
    { original = L["Blessing of Speed"], replacement = L["Spd"] },
    { original = L["Hex of Leeching"], replacement = L["Leech"] },
    { original = L["Rune of Avoidance"], replacement = L["Avoid"] },
    { original = L["Akil'zon's Swiftness"], replacement = L["Akil Swift"] },
    { original = L["Amirdrassil's Grace"], replacement = L["Amir Grc"] },
    { original = L["Silvermoon's Mending"], replacement = L["Smoon Mend"] },
    { original = L["Flight of the Eagle"], replacement = L["Eagle"] },
    { original = L["Nature's Grace"], replacement = L["Nat Grc"] },
    { original = L["Thalassian Recovery"], replacement = L["Thal Rcvry"] },
    { original = L["Mark of Nalorakk"], replacement = L["Mark Nal"] },
    { original = L["Mark of the Magister"], replacement = L["Mark Mag"] },
    { original = L["Mark of the Rootwarden"], replacement = L["Mark Root"] },
    { original = L["Mark of the Worldsoul"], replacement = L["Mark World"] },
    { original = L["Farstrider's Hunt"], replacement = L["Far Hunt"] },
    { original = L["Lynx's Dexterity"], replacement = L["Lynx Dex"] },
    { original = L["Shaldrassil's Roots"], replacement = L["Shal Roots"] },
    { original = L["Eyes of the Eagle"], replacement = L["Eyes Eag"] },
    { original = L["Nature's Fury"], replacement = L["Nat Fury"] },
    { original = L["Silvermoon's Alacrity"], replacement = L["Smoon Alac"] },
    { original = L["Silvermoon's Tenacity"], replacement = L["Smoon Ten"] },
    { original = L["Zul'jin's Mastery"], replacement = L["Zul Mast"] },
    { original = L["Amani Mastery"], replacement = L["Amani Mast"] },
    { original = L["Nature's Wrath"], replacement = L["Nat Wrath"] },
    { original = L["Thalassian Versatility"], replacement = L["Thal Vers"] },
    { original = L["Acuity of the Ren'dorei"], replacement = L["Acu Ren"] },
    { original = L["Arcane Mastery"], replacement = L["Arc Mast"] },
    { original = L["Berserker's Rage"], replacement = L["Bserk Rage"] },
    { original = L["Flames of the Sin'dorei"], replacement = L["Flame Sin"] },
    { original = L["Jan'alai's Precision"], replacement = L["Jan Prec"] },
    { original = L["Strength of Halazzi"], replacement = L["Str Hal"] },
