        ...
        inspectOptions = {
            ...
            args = {
                ...
                showInspectAvgILvl = {
                    ...
                    desc = "Display average item level in the character's class color",
                    order = 14.05,
                    get = function(item) return AddOn.db.profile[item[#item]] end,
                    set = function(item, val)
                        AddOn.db.profile[item[#item]] = val
                ...
                includeAvgText = {
                    type = "toggle",
                    name = "Include \"Avg\" Label",
                    desc = "Adds the text |cFFFFD100\"Avg: \"|r before the average item level.\n\nThis can help easily identify the average item level when there is a lot of information shown in the Inspect window.",
                    order = 14.06,
                    get = function(item) return AddOn.db.profile[item[#item]] end,
                    set = function(item, val)
                        AddOn.db.profile[item[#item]] = val
