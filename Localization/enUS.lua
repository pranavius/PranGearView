...
L["Does nothing if Show Durability as Bar is enabled"] = WrapTextInColor("Does nothing if ", DARKYELLOW_FONT_COLOR)..WrapTextInColor("Show Durability as Bar", WHITE_FONT_COLOR)..WrapTextInColor(" is enabled", DARKYELLOW_FONT_COLOR)
L["High: above 50%"] = WrapTextInColor("High", WHITE_FONT_COLOR)..": above 50%"
L["Medium: 25% - 50%"] = WrapTextInColor("Medium", WHITE_FONT_COLOR)..": 25% - 50%"
L["Low: 25% or less"] = WrapTextInColor("Low", WHITE_FONT_COLOR)..": 25% or less"
L["High"] = "High"
L["Medium"] = "Medium"
L["Low"] = "Low"
...
L["If you would like to contribute to development, you can find the repository on GitHub."] = "If you would like to contribute to development, you can find the repository on "..WrapTextInColorCode("GitHub", "FF1EFF00")
