...
L["Display upgrade track and progress next to item level"] = "Display upgrade track and progress next to item level"
...
L["Customize upgrade track color"] = "Customise upgrade track colour"
