...
L["Use iLevel AddOn Colors"] = "Use iLevel AddOn Colours"
...
L["Color highest item level in green, lowest item level in red, and the rest in orange."] = "Colour highest item level in |cFF1EFF00green|r, lowest item level in |cFFC41E3Ared|r, and the rest in |cFFFF7C0Aorange|r."
L["This color scheme follows a similar pattern to the iLevel AddOn"] = "This colour scheme follows a similar pattern to the |cFFFFD100iLevel|r AddOn"
