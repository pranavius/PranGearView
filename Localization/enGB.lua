local L = LibStub("AceLocale-3.0"):NewLocale("PranGearView", "enGB")
...
L["Outline"] = "Outline"
L["Use Item Quality Color"] = "Use Item Quality Colour"
L["Use Class Color"] = "Use Class Colour"
L["Use Item Level Gradient"] = "Use Item Level Gradient"
L["Use Quality Color Scale"] = "Use Quality Colour Scale"
L["Use Custom Color"] = "Use Custom Colour"
L["Choose a Color"] = "Choose a Colour"
...
L["Specialization"] = "Specialisation"
...
L["Item levels shown in white when no color options are selected"] = "Item levels shown in white when no colour options are selected"
L["Color item levels based on item quality"] = "Colour item levels based on item quality"
L["Color item levels based on the character's class"] = "Colour item levels based on the character's class"
L["Color highest item level in green, lowest item level in red, and the rest in yellow."] = "Colour highest item level in |cFF1EFF00green|r, lowest item level in |cFFFF3300red|r, and the rest in |cFFFFF468yellow|r."
...
L["Customize item level color"] = "Customise item level colour"
L["Customize upgrade track color for current season items"] = "Customise upgrade track colour for current season items"
L["Choose from the color picker or enter the hex code for a specific color."] = "Choose from the colour picker or enter the hex code for a specific colour."
L["Color codes should be entered in the format #RRGGBB"] = "Colour codes should be entered in the format #|cFFff3300RR|cFF1eff00GG|cFF0070ddBB|r"
L["By default, upgrade tracks are shown in the color that matches the quality of the equipment. Upgrade tracks for previous season equipment always appear in gray"] = "By default, upgrade tracks are shown in the colour that matches the quality of the equipment. Upgrade tracks for previous season equipment always appear in grey"
L["Use the item quality color scale when showing upgrade tracks"] = "Use the item quality colour scale when showing upgrade tracks"
...
L["Enchant quality symbol is not affected by the custom color option"] = "Enchant quality symbol is not affected by the custom colour option"
L["Customize enchant text color"] = "Customise enchant text colour"
...
L["Colors, size, and other display settings when inspecting a character will follow the same settings as the Character Info window."] = "Colours, size, and other display settings when inspecting a character will follow the same settings as the Character Info window."
L["Display average item level in the character's class color"] = "Display average item level in the character's class colour"
...
L["Customize secondary & tertiary stat order in the Character Info window by specialization"] = "Customise secondary & tertiary stat order in the Character Info window by specialisation"
...
L["Invalid hexadecimal color code provided."] = "Invalid hexadecimal colour code provided."
