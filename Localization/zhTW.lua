...
L["Does nothing if Show Durability as Bar is enabled"] = WrapTextInColor("如果啟用了", DARKYELLOW_FONT_COLOR)..WrapTextInColor("顯示耐久度為條形", WHITE_FONT_COLOR)..WrapTextInColor("，則不執行任何操作", DARKYELLOW_FONT_COLOR)
